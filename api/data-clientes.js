...
export default async function handler(req,res){
  try{
    ...
    const r=await fetch('https://api.github.com/repos/'+repo+'/contents/clientes-enrichment/latest.json?ref=main',{
    ...
    if(!r.ok) throw new Error('Base de clientes indisponivel ('+r.status+')');
